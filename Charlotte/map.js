...
map.on('load', function () {
    ...
    map.addLayer({
        ...
        'paint': {
            'fill-color': [
                'case',
                ['==', ['get', 'ACSDT5Y2022.B25077-Data_Estimate!!Median value (dollars)'], null], 'transparent',
                ['step', ['get', 'ACSDT5Y2022.B25077-Data_Estimate!!Median value (dollars)'],
                    '#ffffff',
                    0, '#011356',
                    160000, '#01417F',
                    320000, '#016EA8',
